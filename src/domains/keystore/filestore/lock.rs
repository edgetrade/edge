//! Key lock command for filestore.
//!
//! Implements session lock by clearing session keys from the filesystem.
...
///
/// All sensitive key material is removed from the filesystem when locked.
///
/// # Errors
/// Returns an error if:
...
mod tests {
    ...
    use crate::domains::config::Config;
    use crate::domains::keystore::FileStoreSession;
    use crate::domains::keystore::crypto::storage::delete_session_file;
