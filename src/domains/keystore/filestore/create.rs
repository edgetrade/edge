//! Key create command for filestore.
//!
...
pub async fn key_create_internal() -> crate::error::Result<PathBuf> {
...
pub fn key_create() -> crate::error::Result<()> {
    ...
    let storage_dir = runtime.block_on(key_create_internal())?;
...
mod tests {
    ...
    //     let recovered_uek =
    //         crate::domains::keystore::crypto::encryption::unwrap_user_encryption_key(&blind_user_key, &kwk)
    //             .unwrap();
